...
balance = MotionSet(tree.parsexml("152 Balance"), offsets=[darwin, hand,new_hand])
...
l_step = Action(tree.superparsexml("24 F_E_L",offsets=[darwin, hand,new_hand]))
r_step = Action(tree.superparsexml("25 F_E_R",offsets=[darwin, hand,new_hand]))
